"""Rewrite start-ticket-system.bat in GBK with all paths pointing inside D:\fenliu\_runtime."""
import os
...
print("OK - bat rewritten (GBK) with internal paths")
...
print("JAVA_HOME line:", [l.rstrip() for l in lines if 'JAVA_HOME' in l])
print("Redis line:", [l.rstrip() for l in lines if 'redis-server' in l])
print("Maven still referenced:", any('maven' in l.lower() for l in lines))
